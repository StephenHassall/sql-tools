/**
 * Test MySQL database parts
 */
import { SqlConfig, DatabaseType } from "../../sql-config.js";
import { SqlJson } from "../../sql-convert.js";
...
export default class TestMySql {
    /**
     * Run all the MySql tests.
     */
    static async run() {
        // Set test
        Test.test('MySql');

        // Set SqlConfig for MySQL database
        TestMySql._sqlConfig = new SqlConfig();
        TestMySql._sqlConfig.databaseType = DatabaseType.MYSQL;

        // Initialize the database connection
        Database.initialize();

        // Perform tests
        //await TestMySql.testCreateDatabase();
        //await TestMySql.testCreateTable();
     ...
     */
    static async testCreateDatabase() {
        // Set description
        Test.describe('testCreateDatabase');

        // Create create database SQL command
        let sqlTemplate = await SqlTemplateFile.getTemplate('./create-database.sql', import.meta.url, TestMySql._sqlConfig);
    ...
    static async testCreateTable() {
        ...
        let sqlTemplate = await SqlTemplateFile.getTemplate('./create-table.sql', import.meta.url, TestMySql._sqlConfig);
        Test.assert(sqlTemplate);
